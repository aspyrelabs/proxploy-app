 ...
 *
 * Three buttons, not eight. These three are what an operator reaches for
 * repeatedly on a list of running apps; Console, Logs, Reconfigure, Migrate,
 * Backup and Delete are things you do to one app, once, and a row that showed
 * them all would be a wall of words per app. AppIconMenu carries them, the
 * same component the icon grid's tile menu uses, told to leave the lifecycle
 * items out so this row does not offer Restart twice.
 *
