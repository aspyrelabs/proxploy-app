 ...
 * mark on a dark tab strip. The name is a promise about which background the
 * artwork belongs on, and this is what holds it to that.
 */
...
describe('brand artwork', () => {
  it.each(['proxploy-logo-dark.svg', 'proxploy-favicon-dark.svg'])(
  ...
  it.each(['proxploy-logo-light.svg', 'proxploy-favicon-light.svg'])(
  ...
  it.each([
    ...
    ['proxploy-logo-dark.svg', '29 238 967 188'],
    ['proxploy-logo-light.svg', '29 238 967 188'],
