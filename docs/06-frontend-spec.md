...
| `#/storage` | `/storage` | Storage | Header ("N datastores across the cluster", "Add storage"); 3-across datastore cards: icon, name, `node · type`, % badge, used/total TB bar (bar turns red past 80%) |
